    ...
    public static class PropModelExtensions
    {
        ...
        public static PropDoWhenChanged PrepareDoWhenChangedField(this PropModel pm, PropItem pi)
        {
            ...
            if (pm.DeferMethodRefResolution)
                ...
                doWhenChanged = dwcf.DoWhenChanged == null ? "null" : pm.WrapWithGetDelegate(dwcf.DoWhenChanged, pi.Type);
            else
        ...
        public static string GetStringRepForValue(this PropModel pm, string value, string type)
        {
        ...
        public static string WrapWithGetDelegate(this PropModel pm, string delegateName, string type)
        {

...
public partial class TestClass : PropBag
{
	public TestClass() : this(PropBagTypeSafetyMode.Loose) { }

	public TestClass(PropBagTypeSafetyMode typeSafetyMode) : base(typeSafetyMode)
	{
		AddProp<int>("Prop1");

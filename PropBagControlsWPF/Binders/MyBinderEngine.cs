...
namespace DRM.PropBag.ControlsWPF.Binders
{
    public class MyBinderEngine
    {
        ...
        public MyBinderEngine(MyBindingInfo bindingInfo, Type sourceType, DependencyObject targetObject, DependencyProperty targetProperty)
        {
            ...
            List<ObservableSource> dsChangeListeners, Type sourceType, MyBindingInfo bInfo)
        {
            ...
            if (compCount != dsChangeListeners.Count)
            {
                ...
                return CreateDefaultBinding(bInfo.PropertyPath, sourceType, propertyType);
            }
        ...
        private Binding CreateBinding(PropertyPath path, bool isPropBagBased, Type sourceType, Type propertyType)
        {
            Binding result;
        ...
        private Binding CreateDefaultBinding(PropertyPath path, Type sourceType, Type propertyType)
        {

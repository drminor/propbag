...
namespace DRM.TypeSafePropertyBag
{
    ...
    internal interface IProvidePropStoreAccessService<L2T, L2TRaw> : IPropStoreAccessServiceCreator<L2T, L2TRaw>, IDisposable
    {
        ...
        object GetValueFast(WeakRefKey<IPropBag> propBag_wrKey, PropItemSetKeyType propItemSetKey, ExKeyT compKey);
        bool SetValueFast(WeakRefKey<IPropBag> propBag_wrKey, PropItemSetKeyType propItemSetKey, ExKeyT compKey, object value);

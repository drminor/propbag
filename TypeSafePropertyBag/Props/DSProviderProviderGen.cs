...
namespace DRM.TypeSafePropertyBag
{
    ...
    internal class DSProviderProviderGen : IProvideADataSourceProvider<object>
    {
        ...
        public DSProviderProviderGen(PropKindEnum propKind, PropIdType propId, PSAccessServiceInternalType storeAccesor)
        {
            _propKind = propKind;
            
            if(! (_propKind == PropKindEnum.ObservableCollection/* || _propKind == PropKindEnum.ObservableCollectionFB*/))
            {
                throw new NotSupportedException($"This IProvideADataSourceProvider {nameof(DSProviderProviderGen)} cannot create a DataSourceProvider for Prop Items with Kind = {_propKind}.");
            }

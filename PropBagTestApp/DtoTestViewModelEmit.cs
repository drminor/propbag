...
namespace PropBagTestApp
{
    public class DtoTestViewModelEmit : PropBag
    {
        ...
        public DtoTestViewModelEmit() : base(PropBagTypeSafetyMode.None, storeAcessorCreator: null, propFactory: null, fullClassName: null) { } // Shows that if no default constructor is available, the one that takes a single byte is use.
